...
<div class="collapse" id="codeCollapse0">
	<pre><code class="html">{literal}```<div class="card">...</div>```{/literal}</code></pre>
</div>
...
<div class="row row-spacing">
	<div class="col-md-12">
		...
		<blockquote class="blockquote-sm blockquote-success">
			<p>Use <code>{literal}card-row{/literal}</code> with <code>{literal}card-col-content{/literal}</code> and <code>{literal}card-col-field{/literal}</code> to create a number of custom horizontal cards. <code>{literal}card-col-content{/literal}</code> fills the remaining space when used in conjunction with <code>{literal}card-col-field{/literal}</code>. <code>{literal}card-col-field{/literal}</code> will only be as wide as the content inside.
		</blockquote>
	</div>
...
<div class="collapse" id="codeCollapse001">
	<pre><code class="html">{literal}```<div class="card card-horizontal">
    <div class="card-row card-row-padded">
        <div class="card-col-field">
            <span class="icon-folder-close-alt sticker sticker-default sticker-static sticker-lg"></span>
        </div>
...
<div class="row row-spacing">
	<div class="col-md-12">
		<h3>Horizontal Cards with Fixed Width Content</h3>

		<blockquote class="blockquote-sm blockquote-success">
			<p>Set a fixed width on the content inside <code>{literal}card-col-field{/literal}</code>.</p>
		</blockquote>
	</div>
	...
	<div class="col-md-6">
		<div class="card card-horizontal">
			<div class="card-row">
				<div class="card-col-field">
					<img alt="thumbnail" src="ROOTPATH/images/thumbnail_placeholder.gif" style="width: 150px;">
				</div>
	...
	<div class="col-md-6">
		<div class="card card-horizontal">
			<div class="card-row card-row-padded">
				<div class="card-col-field">
					<img alt="thumbnail" src="ROOTPATH/images/thumbnail_placeholder.gif" style="width: 121px;">
				</div>
...
<div class="row row-spacing" id="truncatingText">
	<div class="col-md-12">
		<h3>Truncating Text Inside Card</h3>

		<blockquote class="blockquote-sm blockquote-success">
			<p>Add class <code>{literal}truncate-text{/literal}</code> on whatever text you want to be truncated.</p>
		</blockquote>
	</div>
...
<div class="row row-spacing uxgl-horizontal-card">
	<div class="col-md-12">
		...
		<blockquote class="blockquote-sm blockquote-success">
			<p>Vertically align content by setting the css property <code>{literal}vertical-align{/literal}</code> on the card-col and align content horizontally by using <code>{literal}text-align{/literal}</code> or use the helper classes <code>{literal}card-row-valign-bottom{/literal}</code>and <code>{literal}card-row-valign-top{/literal}</code> on the <code>{literal}card-row{/literal}</code> to vertically align all columns inside the row.</p>
		</blockquote>
	</div>
...
<div class="row row-spacing">
	<div class="col-md-12">
		<blockquote class="blockquote-sm blockquote-success">
			<p>Add gutters to a specific card card column by using the class <code>{literal}card-col-gutters{/literal}</code>.</p>
		</blockquote>
	</div>
...
<div class="collapse" id="codeCollapse3">
	...
	<div class="col-md-12">
		<blockquote class="blockquote-sm blockquote-success">
			<p>Use <code>{literal}card-row-padded{/literal}</code> on <code>{literal}card-row{/literal}</code> to add some spacing around a horizontal card.</p>
		</blockquote>
	</div>
...
<div class="row row-spacing">
	<div class="col-md-12">
		...
		<blockquote class="blockquote-sm blockquote-success">
			<p>Use classes <code>{literal}card-rounded{/literal}</code>, <code>{literal}card-circle{/literal}</code>, or <code>{literal}card-square{/literal}</code> on the card to quickly shape the borders.</p>
		</blockquote>
	</div>
...
<div class="collapse" id="codeCollapse5">
	<pre><code class="html">{literal}```<div class="card card-horizontal card-rounded">...</div>
<div class="card card-circle card-horizontal">...</div>
<div class="card card-horizontal card-square">...</div>```{/literal}</code></pre>
</div>
	...
	<div class="col-md-12">
		<blockquote class="blockquote-sm blockquote-success">
			We didn't add <code>{literal}overflow: hidden{/literal}</code> to the <code>{literal}card{/literal}</code> class because it prevents nested dropdowns, popups, and tooltips from fully displaying. You can work around this by adding <code>{literal}border-radius{/literal}</code> to the image or <code>{literal}overflow: hidden{/literal}</code> to the card.
		</blockquote>
...
<div class="row row-spacing">
	<div class="col-md-12">
		...
		<blockquote class="blockquote-sm blockquote-success">
			<p>Use <code>{literal}```<div class="divider"></div>```{/literal}</code> to create a horizontal division between content inside a card.</p>
		</blockquote>
	</div>
...
<div class="row row-spacing">
	<div class="col-md-12">
		...
		<pre><code>{literal}```<div class="checkbox checkbox-card checkbox-top-left">
    <label>
        <input type="checkbox">
    </label>
    <div class="card">...</div>
...
<div class="row row-spacing">
	<div class="col-md-12">
		...
		<pre><code>{literal}```<div class="radio radio-card radio-top-left">
    <label>
        <input type="radio">
    </label>
    <div class="card">...</div>
