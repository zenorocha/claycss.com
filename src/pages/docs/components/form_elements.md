...
<div class="row">
	<div class="col-md-12">
		...
		<blockquote class="blockquote-sm blockquote-success">
			<p>Add class <code>{literal}focus{/literal}</code> on the label to change the color of the label.</p>
		</blockquote>
...
<div class="row row-spacing">
	<div class="col-md-12">
		<h3>Checkboxes and Radios (no extra mark up)</h3>
	</div>

	<div class="col-md-6">
		<h5>Checkboxes</h5>

<!-- Checkboxes unable to be styled in Firefox with this method. See https://bugzilla.mozilla.org/show_bug.cgi?id=605985
Checkboxes unable to be styled in IE with this method. -->
	...
	<div class="col-md-6">
		...
		<div class="radio">
			<label class="radio-inline">
				<input id="inlineRadio1" name="inlineRadioOptions1" type="radio" value="option1"> 1
			</label>
			<label class="radio-inline">
				<input id="inlineRadio2" name="inlineRadioOptions1" type="radio" value="option2"> 2
			</label>
			<label class="radio-inline">
				<input id="inlineRadio3" name="inlineRadioOptions1" type="radio" value="option3"> 3
			</label>
		</div>
	</div>
</div>
...
<div class="collapse" id="codeCollapse3">
  <pre><code class="html">{literal}```<div class="checkbox">
    <label>
        <input type="checkbox" value="">
...
<div class="row row-spacing">
	<div class="col-md-12">
		...
		<blockquote class="blockquote-sm blockquote-success">
			<p>Add class <code>{literal}disabled{/literal}</code> on the label to match the opacity to disabled input.</p>
		</blockquote>
...
<div class="collapse" id="codeCollapse7">
	<pre><code class="html">{literal}```<form>
    <fieldset disabled="">
        <div class="form-group">
            <label for="disabledTextInput">Disabled input</label>
