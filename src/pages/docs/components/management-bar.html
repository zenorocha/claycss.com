...
<div class="row row-spacing">
	<div class="col-md-12">
		...
		<blockquote class="blockquote-success blockquote-sm">
			<p>Management Bar is an extension of Navbar. Combine different management-bar components to create a toolbar that fits your needs.</p>
		</blockquote>
		...
		<div class="management-bar">
			<div class="management-bar-header">
				...
				<a class="management-bar-toggle management-bar-toggle-link collapsed" data-toggle="collapse" href="#mgmtBarCollapse00">
			...
			<div class="management-bar-header-right">
				...
				<a class="btn btn-link hidden-xs" href="#">
					<svg class="icon-monospaced lexicon-icon">
...
<div class="row row-spacing">
	<div class="col-md-12">
		<h3>Management Bar Default</h3>

		<blockquote class="blockquote-success blockquote-sm">
			<p>Default Skin for Management Bar</p>
		</blockquote>
...
<div class="collapse" id="codeCollapse0">
	<pre><code class="html">{literal}```<div class="management-bar management-bar-default">
    <div class="management-bar-header">
        <div class="checkbox">
            <label>
                <input type="checkbox" value="">
...
<div class="row row-spacing">
	<div class="col-md-12">
		<h3>Management Bar No Collapse</h3>

		<blockquote class="blockquote-success blockquote-sm">
			<p>Use class <code>{literal}management-bar-no-collapse{/literal}</code> on <code>{literal}management-bar{/literal}</code> to preserve desktop management-bar styles in mobile.</p>
		</blockquote>
...
<div class="collapse" id="codeCollapse1">
	<pre><code class="html">{literal}```<div class="management-bar management-bar-default management-bar-no-collapse">
    <ul class="nav management-bar-nav">
        <li>
            <div class="checkbox">
                <label>
    ...
    <ul class="nav management-bar-nav management-bar-nav-right">
        <li>
            <a class="btn" href="#"><span class="icon-trash icon-monospaced"></span></a>
        </li>
        <li>
            <a class="btn" href="#"><span class="icon-ellipsis-vertical icon-monospaced"></span></a>
        </li>
    </ul>
</div>```{/literal}</code></pre>
</div>
...
{literal}
	<script>
		...
		$('input[type="email"]').on('focus', function(event) {
			$(this).closest('.form-group').addClass('focus');
		});
		...
		$('input[type="checkbox"]').on('blur', function(event) {
