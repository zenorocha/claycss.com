...
<div class="row row-spacing uxgl-alerts">
	<div class="col-md-12">
		<h3>Alerts with Embedded Links</h3>

		<blockquote class="blockquote-sm blockquote-success">
			<p>Use <code>{literal}.lead{/literal}</code> inside of an alert to make the beginning of your message stand out.</p>

			<p>Use <code>{literal}.alert-link{/literal}</code> to style a link inside your alert.</p>
		</blockquote>
...
<div class="collapse" id="codeCollapse4">
	<pre><code class="html">{literal}```<div class="alert alert-danger">
    <strong class="lead">Danger</strong> <a href="#" class="alert-link">Something</a> is not right.
...
<div class="collapse" id="codeCollapse9">
	<pre><code class="html">{literal}```<div class="alert alert-dismissible alert-danger" data-dismiss="alert" role="alert">
    <button class="close" type="button">
        <svg aria-hidden="true" class="icon-monospaced lexicon-icon">
            <use xlink:href="ROOTPATH/images/icons/icons.svg#times" />
        </svg>
...
<div class="collapse" id="codeCollapse10">
  <pre><code class="html">{literal}```<div class="alert alert-dismissible alert-notification alert-danger" data-dismiss="alert" role="alert">
        <button class="close" type="button">
            <svg aria-hidden="true" class="icon-monospaced lexicon-icon">
                <use xlink:href="ROOTPATH/images/icons/icons.svg#times" />
            </svg>
