...
<div class="row row-spacing">
	<div class="col-md-12">
		...
		<blockquote class="blockquote-sm blockquote-success">
			<p>Preset pagination styles helps divide up large blocks of content on your site or app. Use class <code>{literal}ellipsis{/literal}</code> or <code>{literal}dropdown{/literal}</code> on a pagination list item to separate pagination controls from page numbers.</p>
		</blockquote>
...
<div class="collapse" id="codeCollapse0">
	<pre><code class="html">{literal}```<ul class="pagination">
    <li class="disabled"><a href="#1"><span class="icon-caret-left"></span></a></li>
    <li class="disabled"><a href="#1"><span class="icon-double-angle-left"></span></a></li>
    <li class="active"><a href="#1">1</a></li>
    <li><a href="#1">2</a></li>
...
<div class="collapse" id="codeCollapse1">
	<pre><code class="html">{literal}```<div class="dropdown pagination-items-per-page">
    <a class="dropdown-toggle" data-toggle="dropdown" href="#1">10 entries <span class="icon-sort"></span></a>
    <ul class="dropdown-menu">
        <li><a href="#1">5</a></li>
        <li><a href="#1">10</a></li>
