...
<div class="lx-site-test-assorted-modal">
...
<div class="lx-site-test-assorted-sidebar">
	<div class="sidebar sidebar-default">
		...
		<!-- navbar-no-collapse without container-fluid -->
		<nav class="navbar navbar-default navbar-no-collapse">
			<ul class="nav navbar-nav">
				<li class="active dropdown">
					<a aria-expanded="false" class="dropdown-toggle" data-toggle="dropdown" href="#1" role="button">Details <span class="caret"></span></a>
		...
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				<div class="navbar-header visible-xs">
					<button aria-expanded="false" class="collapsed navbar-toggle navbar-toggle-left navbar-toggle-page-name" data-target="#sidebar-navbar-default-collapse-001" data-toggle="collapse" type="button">
						<span class="sr-only">Toggle Navigation</span>
						<span class="page-name">Message Boards</span>
						<span class="caret"></span>
					</button>
				</div>

				<div aria-expanded="false" class="collapse navbar-collapse navbar-collapse-left" id="sidebar-navbar-default-collapse-001">
					<ul class="nav navbar-nav">
						<li class="active"><a href="#1">Message Boards</a></li>
						<li class="dropdown">
							<a class="dropdown-toggle" data-toggle="dropdown" href="#1">Dropdown <span class="caret"></span></a>
							<ul aria-labelledby="dropdownMenu" class="dropdown-menu">
								<li class="dropdown-header" role="presentation">Dropdown Header</li>
								<li role="presentation"><a href="#1">Actions</a></li>
								<li role="presentation"><a href="#1">Edit</a></li>
								<li role="presentation"><a href="#1">View</a></li>
								<li role="presentation"><a href="#1">Permissions</a></li>
								<li class="disabled" role="presentation"><a href="#1" role="menuitem">Disabled</a></li>
								<li class="divider" role="presentation"></li>
								<li role="presentation"><a href="#1" role="menuitem">Scope</a></li>
							</ul>
		...
		<!-- navbar without container-fluid -->
		<nav class="navbar navbar-default">
			<div class="navbar-header visible-xs">
				<button aria-expanded="false" class="collapsed navbar-toggle navbar-toggle-left navbar-toggle-page-name" data-target="#sidebar-navbar-default-collapse-002" data-toggle="collapse" type="button">
					<span class="sr-only">Toggle Navigation</span>
					<span class="page-name">Message Boards</span><!-- current page name goes here e.g. Message Boards Home -->
					<span class="caret"></span>
				</button>
			...
			<div aria-expanded="false" class="collapse navbar-collapse navbar-collapse-left" id="sidebar-navbar-default-collapse-002">
				<ul class="nav navbar-nav">
					<li class="active"><a href="#1">Message Boards</a></li>
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#1">Dropdown <span class="caret"></span></a>
		...
		<div class="sidebar-body">
			<div class="crop-img crop-img-center crop-img-middle sidebar-panel">
				<img alt="thumbnail" class="img-responsive" src="../../images/switch_on_icon.png">
				<div class="sticker sticker-bottom-left sticker-success">PNG</div>
			</div>

			<div class="crop-img crop-img-center crop-img-middle sidebar-panel">
				<img alt="thumbnail" class="img-responsive" src="../../images/DeathtoStock_Desk4.jpg">
				<div class="sticker sticker-bottom-left sticker-danger">JPG</div>
			</div>

			<div class="crop-img crop-img-center crop-img-middle sidebar-panel">
				<img alt="thumbnail" class="img-responsive" src="../../images/thumbnail_typewriter.jpg">
				<div class="sticker sticker-bottom-left sticker-danger">JPG</div>
			</div>
			...
			<dl class="sidebar-block">
				...
				<dd class="h6 sidebar-caption">By <a href="#1">Helen Smith</a> on Feb 15 2015, 10:15am</dd>
			...
			<div class="sidebar-block">
				...
				<div style="margin-bottom: 20px;margin-top:20px;">
					<a class="btn btn-default btn-sm" href="#1" id="addNewTagButton">Add new tag</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="sidebar sidebar-inverse">
		...
		<!-- navbar-no-collapse with container-fluid -->
		<nav class="navbar navbar-inverse navbar-no-collapse">
			<div class="container-fluid">
				<ul class="nav navbar-nav">
					<li class="active dropdown">
						<a aria-expanded="true" class="dropdown-toggle" data-toggle="dropdown" href="#1" role="button">Details <span class="caret"></span></a>
						<ul class="dropdown-menu" role="menu">
							<li><a href="#1">Details</a></li>
							<li><a href="#1">Versions</a></li>
							<li><a href="#1">Comments (17)</a></li>
		...
		<nav class="navbar navbar-inverse">
			<div class="container-fluid">
				<div class="navbar-header visible-xs">
					<button aria-expanded="false" class="collapsed navbar-toggle navbar-toggle-left navbar-toggle-page-name" data-target="#sidebar-navbar-inverse-collapse-001" data-toggle="collapse" type="button">
						<span class="sr-only">Toggle Navigation</span>
						<span class="page-name">Message Boards</span><!-- current page name goes here e.g. Message Boards Home -->
						<span class="caret"></span>
					</button>
				...
				<div aria-expanded="false" class="collapse navbar-collapse navbar-collapse-left" id="sidebar-navbar-inverse-collapse-001">
					<ul class="nav navbar-nav">
						<li class="active"><a href="#1">Message Boards</a></li>
						<li class="dropdown">
							<a class="dropdown-toggle" data-toggle="dropdown" href="#1">Dropdown <span class="caret"></span></a>
		...
		<nav class="navbar navbar-inverse">
			<div class="navbar-header visible-xs">
				<button aria-expanded="false" class="collapsed navbar-toggle navbar-toggle-left navbar-toggle-page-name" data-target="#sidebar-navbar-inverse-collapse-002" data-toggle="collapse" type="button">
					<span class="sr-only">Toggle Navigation</span>
					<span class="page-name">Message Boards</span><!-- current page name goes here e.g. Message Boards Home -->
					<span class="caret"></span>
				</button>
			...
			<div aria-expanded="false" class="collapse navbar-collapse navbar-collapse-left" id="sidebar-navbar-inverse-collapse-002">
				<ul class="nav navbar-nav">
					<li class="active"><a href="#1">Message Boards</a></li>
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#1">Dropdown <span class="caret"></span></a>
		...
		<div class="sidebar-body">
			<div class="crop-img crop-img-center crop-img-middle sidebar-panel">
				<img alt="thumbnail" class="img-responsive" src="../../images/switch_off_icon.png">
				<div class="sticker sticker-bottom-left sticker-success">PNG</div>
			</div>

			<div class="crop-img crop-img-center crop-img-middle sidebar-panel">
				<img alt="thumbnail" class="img-responsive" src="../../images/DeathtoStock_Spring10.jpg">
				<div class="sticker sticker-bottom-left sticker-danger">JPG</div>
			</div>
