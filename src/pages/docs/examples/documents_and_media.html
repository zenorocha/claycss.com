...
<div class="row" id="documentsAndMediaExample">
	<div class="col-md-12">
		<div class="closed sidenav-container sidenav-js-fouc" id="documentsAndMediaSidenav">
				...
				<div class="sidebar sidebar-inverse sidenav-menu">
					<div class="sidebar-header">
						...
						<a class="sidebar-title" href="#1">
							<div class="sticker sticker-static sticker-success">
					...
					<div class="container-fluid-1280">
						<div class="toolbar-group">
							<div class="toolbar-group-content">
								<a class="sidenav-toggler" href="#documentsAndMediaSidenav" id="documentsAndMediaToggler">
									<svg class="icon-monospaced lexicon-icon lexicon-icon-bars">
							...
							<div class="toolbar-group-content">
								<div class="dropdown">
									<a class="dropdown-toggle" data-toggle="dropdown" href="#1">
										<svg class="icon-monospaced lexicon-icon lexicon-icon-cog">
				...
				<nav class="collapse-basic-search navbar navbar-default navbar-no-collapse">
					<div class="container-fluid-1280">
						<ul class="nav navbar-nav">
							<li class="active"><a href="#1">All Posts</a></li>
						</ul>
					</div>
				</nav>
							...
							<ul class="management-bar-nav management-bar-nav-right nav">
								<li>
									<a class="active btn btn-default open" href="#documentsAndMediaRightSidenav" id="documentsAndMediaRightSidenavToggler">
										<svg class="icon-monospaced lexicon-icon lexicon-icon-info-circle">
								...
								<li>
									<a class="btn btn-default" href="#">
										<svg class="icon-monospaced lexicon-icon lexicon-icon-trash">
								...
								<li class="dropdown">
									<a class="btn btn-default dropdown-toggle" data-toggle="dropdown" href="#">
										<svg class="icon-monospaced lexicon-icon lexicon-icon-ellipsis-v">
							...
							<div class="sidebar sidebar-default sidenav-menu">
								<div class="sidebar-header">
									<ul class="sidebar-actions">
										<li>
											<a href="#1">
												<svg class="icon-monospaced lexicon-icon lexicon-icon-star-o">
									...
									<h5>Approved</h5>
									<h6 class="sidebar-caption">Users are allowed to request membership. The request is accepted automatically.</h6>
								</div>
								...
								<div class="sidebar-body">
									...
									<div style="margin-bottom:20px;margin-top: 20px;">
										<a class="btn btn-default btn-sm" href="#1">Download</a>
									</div>
									...
									<dl class="sidebar-block">
										...
										<dd>By Helen Smith on Feb 15 2015, 10:15am</dd>
...
<a class="btn btn-action btn-bottom-right btn-primary" data-placement="left" data-toggle="tooltip" href="#1" id="fullscreenBtn" title="Fullscreen">
	<span class="icon-monospaced"><span class="icon-desktop"></span></span>
</a>
	...
	<script>
		$('#fullscreenBtn').on(
			'click',
				...
				$('#documentsAndMediaExample').toggleClass('uxgl-fullscreen-fixed');
				$('body').toggleClass('fixed');
			}
		);

		$('#documentsAndMediaToggler').sideNavigation(
			{
				gutter: 0,
				position: 'left',
				type: 'fixed-push',
		...
		$('#documentsAndMediaRightSidenavToggler').sideNavigation(
			{
				gutter: 0,
				position: 'right',
				typeMobile: 'fixed',
